/**
 * Animated Beam — traveling light between two DOM elements.
 * Adapted from Magic UI (MIT). Uses framer-motion animated SVG gradients.
 */
...
export function AnimatedBeam({
  ...
  pathWidth = 2,
  pathOpacity = 0.2,
  gradientStartColor = "#5bc0eb",
  gradientStopColor = "#93c5e8",
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
